...
#pragma config(Motor,  mtr_S1_C2_2,     front_right,   tmotorTetrix, openLoop)
...
task main()
{
	...
	motor[front_left]= -100; //drive off ramp
	...
	motor[front_left]= 100;//left turn
	motor[front_right]= 100;
	motor[back_left]= 100;
	motor[back_right]= 100;
	...
	motor[front_left]= 100;// drive backward
	motor[front_right]= -100;
	motor[back_right]= -100;
	motor[back_left]= 100;
